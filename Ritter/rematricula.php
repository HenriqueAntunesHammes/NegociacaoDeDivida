 ...
 <div class="col-md-12">
   <br>
     <div class="text-center">
        <img src="../images/rematricula.png" alt="img rematricula" width="1000px" height="500px">
     </div>
     <footer class="mastfoot mt-auto">
       <div  id="footer" class="inner">
         <p>Website desenvolvido por <a href="https://antunesdev.com"> Antunes Technology and Development </a>.</p>
       </div>
     </footer>
 </div>
