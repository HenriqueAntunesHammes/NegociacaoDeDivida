...
.btn-circle {
 ...
 <div class="col-md-12">
     <div class="text-center">
        <img src="../images/rematricula-divida.png" alt="img rematricula" width="1000px" height="500px">
     </div><br>
     <div class="row col-md-12 text-center">
     <div class="col-md-6">
        <button ype="button" class="btn btn-warning btn-circle btn-xl">
           <img src="../images/icon.png" alt="icon exemple" width="55px" height="55px">
        </button>
        <br>
     ...
     <div class="col-md-6">
        <button ype="button" class="btn btn-warning btn-circle btn-xl">
           <img src="../images/icon-divida.png" alt="icon exemple" width="75px" height="75px">
        </button>
        <br>
